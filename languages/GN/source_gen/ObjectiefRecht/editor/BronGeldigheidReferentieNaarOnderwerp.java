...
public class BronGeldigheidReferentieNaarOnderwerp implements ConceptEditorComponent {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_o16nnw_a(editorContext, node);
  }
  private EditorCell createCollection_o16nnw_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_o16nnw_a");
    editorCell.addEditorCell(this.createConstant_o16nnw_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_o16nnw_b0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_o16nnw_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_o16nnw_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_o16nnw_e0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_o16nnw_f0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_o16nnw_g0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_o16nnw_h0(editorContext, node));
  ...
  private EditorCell createConstant_o16nnw_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Constant_o16nnw_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_o16nnw_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_o16nnw_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_o16nnw_c0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
    provider.setRole("conceptnummer");
    provider.setNoTargetText("<no conceptnummer>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(editorContext);
    editorCell.setCellId("BGRNO_property_conceptnummer");
  ...
  private EditorCell createConstant_o16nnw_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Geldig van");
    editorCell.setCellId("Constant_o16nnw_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_o16nnw_e0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_o16nnw_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_o16nnw_f0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidReferentieNaarOnderwerp.brongeldigVanSingleRoleHandler_o16nnw_f0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244baL, "brongeldigVan"), editorContext);
    return provider.createCell();
  }
  private class brongeldigVanSingleRoleHandler_o16nnw_f0 extends SingleRoleCellProvider {
    public brongeldigVanSingleRoleHandler_o16nnw_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_o16nnw_g0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Geldig tot");
    editorCell.setCellId("Constant_o16nnw_g0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_o16nnw_h0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_o16nnw_h0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_o16nnw_i0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidReferentieNaarOnderwerp.brongeldigTotSingleRoleHandler_o16nnw_i0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244bcL, "brongeldigTot"), editorContext);
    return provider.createCell();
  }
  private class brongeldigTotSingleRoleHandler_o16nnw_i0 extends SingleRoleCellProvider {
    public brongeldigTotSingleRoleHandler_o16nnw_i0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
  ...
  private EditorCell createConstant_o16nnw_k0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_o16nnw_k0");
    editorCell.setDefaultText("");
    return editorCell;
  }
