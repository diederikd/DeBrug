...
public class Na_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_n1bc1o_a(editorContext, node);
  }
  private EditorCell createCollection_n1bc1o_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_n1bc1o_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefNode_n1bc1o_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_n1bc1o_b0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_n1bc1o_c0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_n1bc1o_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Na_Editor.expressie1SingleRoleHandler_n1bc1o_a0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b135L, "expressie1"), editorContext);
    return provider.createCell();
  }
  private class expressie1SingleRoleHandler_n1bc1o_a0 extends SingleRoleCellProvider {
    public expressie1SingleRoleHandler_n1bc1o_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_n1bc1o_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "na");
    editorCell.setCellId("Constant_n1bc1o_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_n1bc1o_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Na_Editor.expressie2SingleRoleHandler_n1bc1o_c0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b137L, "expressie2"), editorContext);
    return provider.createCell();
  }
  private class expressie2SingleRoleHandler_n1bc1o_c0 extends SingleRoleCellProvider {
    public expressie2SingleRoleHandler_n1bc1o_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
