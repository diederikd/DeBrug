...
public class Rechtsbetrekking_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_trpnxn_a(EditorContext editorContext, SNode node) {
    ...
    if (renderingCondition_trpnxn_a52a(node, editorContext)) {
      editorCell.addEditorCell(this.createCollection_trpnxn_z0(editorContext, node));
    }
  ...
  private EditorCell createRefNode_trpnxn_u0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.GeldigVanSingleRoleHandler_trpnxn_u0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x3b480c109781917eL, "GeldigVan"), editorContext);
    return provider.createCell();
  }
  ...
  private EditorCell createRefNode_trpnxn_x0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.GeldigTotSingleRoleHandler_trpnxn_x0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x3b480c1097819187L, "GeldigTot"), editorContext);
    return provider.createCell();
  }
  ...
  private EditorCell createCollection_trpnxn_z0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_trpnxn_z0");
    editorCell.addEditorCell(this.createConstant_trpnxn_a52a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_trpnxn_b52a(editorContext, node));
    editorCell.addEditorCell(this.createMultiline_trpnxn_c52a(editorContext, node));
    return editorCell;
  }
  private static boolean renderingCondition_trpnxn_a52a(SNode node, EditorContext editorContext) {
    SNode context;
  ...
  private EditorCell createConstant_trpnxn_a52a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_trpnxn_b52a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
