...
public class Rechtsbetrekking_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_trpnxn_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_trpnxn_p0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createRefNode_trpnxn_u0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createRefNode_trpnxn_x0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_trpnxn_y0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createRefNode_trpnxn_bb0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_trpnxn_cb0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_trpnxn_db0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_trpnxn_eb0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_trpnxn_fb0(editorContext, node));
    if (renderingCondition_trpnxn_a23a(node, editorContext)) {
      editorCell.addEditorCell(this.createCollection_trpnxn_gb0(editorContext, node));
    }
    editorCell.addEditorCell(this.createConstant_trpnxn_hb0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_trpnxn_p0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.VoorwaardenSingleRoleHandler_trpnxn_p0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x25be3715c7b32639L, "Voorwaarden"), editorContext);
    return provider.createCell();
  }
  private class VoorwaardenSingleRoleHandler_trpnxn_p0 extends SingleRoleCellProvider {
  ...
  private EditorCell createRefNode_trpnxn_u0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.geldigVanSingleRoleHandler_trpnxn_u0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x805ce2b16e426b6L, "geldigVan"), editorContext);
    return provider.createCell();
  }
  private class geldigVanSingleRoleHandler_trpnxn_u0 extends SingleRoleCellProvider {
  ...
  private EditorCell createRefNode_trpnxn_x0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.geldigTotSingleRoleHandler_trpnxn_x0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x805ce2b16e426bbL, "geldigTot"), editorContext);
    return provider.createCell();
  }
  private class geldigTotSingleRoleHandler_trpnxn_x0 extends SingleRoleCellProvider {
  ...
  private EditorCell createConstant_trpnxn_y0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
  ...
  private EditorCell createRefNode_trpnxn_bb0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.GeldigVanSingleRoleHandler_trpnxn_bb0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x3b480c109781917eL, "GeldigVan"), editorContext);
    return provider.createCell();
  }
  private class GeldigVanSingleRoleHandler_trpnxn_bb0 extends SingleRoleCellProvider {
    public GeldigVanSingleRoleHandler_trpnxn_bb0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
  ...
  private EditorCell createConstant_trpnxn_cb0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "geldig tot");
    editorCell.setCellId("Constant_trpnxn_cb0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_trpnxn_eb0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Editor.GeldigTotSingleRoleHandler_trpnxn_eb0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d0dL, 0x3b480c1097819187L, "GeldigTot"), editorContext);
    return provider.createCell();
  }
  private class GeldigTotSingleRoleHandler_trpnxn_eb0 extends SingleRoleCellProvider {
    public GeldigTotSingleRoleHandler_trpnxn_eb0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
  ...
  private EditorCell createConstant_trpnxn_fb0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_trpnxn_fb0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createCollection_trpnxn_gb0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_trpnxn_gb0");
    editorCell.addEditorCell(this.createConstant_trpnxn_a23a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_trpnxn_b23a(editorContext, node));
    editorCell.addEditorCell(this.createMultiline_trpnxn_c23a(editorContext, node));
    return editorCell;
  }
  private static boolean renderingCondition_trpnxn_a23a(SNode node, EditorContext editorContext) {
    SNode context;
  ...
  private EditorCell createConstant_trpnxn_a23a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "opmerkingen");
    editorCell.setCellId("Constant_trpnxn_a23a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_trpnxn_b23a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_trpnxn_b23a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createMultiline_trpnxn_c23a(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new MultilineCellProvider(node, editorContext);
  ...
  private EditorCell createConstant_trpnxn_hb0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_trpnxn_hb0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
