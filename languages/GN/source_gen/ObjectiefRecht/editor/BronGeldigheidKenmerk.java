...
public class BronGeldigheidKenmerk implements ConceptEditorComponent {
  ...
  private EditorCell createCollection_wh7tcl_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_wh7tcl_c0(editorContext, node));
  ...
  private EditorCell createRefNode_wh7tcl_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidKenmerk.brongeldigVanSingleRoleHandler_wh7tcl_c0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244baL, "brongeldigVan"), editorContext);
    return provider.createCell();
  }
  private class brongeldigVanSingleRoleHandler_wh7tcl_c0 extends SingleRoleCellProvider {
    public brongeldigVanSingleRoleHandler_wh7tcl_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_wh7tcl_f0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidKenmerk.brongeldigTotSingleRoleHandler_wh7tcl_f0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244bcL, "brongeldigTot"), editorContext);
    return provider.createCell();
  }
  private class brongeldigTotSingleRoleHandler_wh7tcl_f0 extends SingleRoleCellProvider {
    public brongeldigTotSingleRoleHandler_wh7tcl_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = super.createChildCell(child);
  ...
  private EditorCell createProperty_wh7tcl_l0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("BGK_property_uniek");
