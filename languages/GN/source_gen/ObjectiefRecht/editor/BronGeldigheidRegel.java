...
public class BronGeldigheidRegel implements ConceptEditorComponent {
  ...
  private EditorCell createCollection_2mxts0_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_2mxts0_c0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createConstant_2mxts0_g0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_2mxts0_h0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_2mxts0_i0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_2mxts0_c0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_2mxts0_f0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidRegel.brongeldigVanSingleRoleHandler_2mxts0_f0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244baL, "brongeldigVan"), editorContext);
    return provider.createCell();
  }
  private class brongeldigVanSingleRoleHandler_2mxts0_f0 extends SingleRoleCellProvider {
  ...
  private EditorCell createConstant_2mxts0_g0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_2mxts0_h0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_2mxts0_h0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_2mxts0_i0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidRegel.brongeldigTotSingleRoleHandler_2mxts0_i0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244bcL, "brongeldigTot"), editorContext);
    return provider.createCell();
  }
  private class brongeldigTotSingleRoleHandler_2mxts0_i0 extends SingleRoleCellProvider {
