  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    {
      ...
      switch (switchIndex) {
        ...
        case 21:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new ReferentieNaarKenmerkMetOnderwerp_Editor());
          }
          break;
        case 22:
          if (true) {
