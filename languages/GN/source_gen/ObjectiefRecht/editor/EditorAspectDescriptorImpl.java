...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  private Collection<ConceptEditorHint> myHints = Arrays.<ConceptEditorHint>asList(new ConceptEditorHintImpl("Kort", "", false, "ObjectiefRecht.editor.GN.Kort"), new ConceptEditorHintImpl("MetLidwoord", "", false, "ObjectiefRecht.editor.GN.MetLidwoord"), new ConceptEditorHintImpl("EN", "English", true, "ObjectiefRecht.editor.GN.EN"));
  @NotNull
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    {
      ...
      switch (switchIndex) {
        ...
        case 54:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new TenMinste_Editor());
          }
          break;
        case 55:
          if (true) {
