...
public class Onderwerp_Editor extends DefaultNodeEditor {
  ...
  private static class kenmerkListHandler_5e6yc7_a1a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(kenmerkListHandler_5e6yc7_a1a0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x218d2fe3c8aff5b9L, 0x4916e0625cef888cL, "kenmerk")));
      try {
  ...
  private EditorCell createCollection_5e6yc7_e0a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_5e6yc7_b4a0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_5e6yc7_b4a0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Onderwerp_Editor.uniekIdentificerendeKenmerkenListHandler_5e6yc7_b4a0(node, "uniekIdentificerendeKenmerken", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_uniekIdentificerendeKenmerken");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
  private static class uniekIdentificerendeKenmerkenListHandler_5e6yc7_b4a0 extends RefNodeListHandler {
    public uniekIdentificerendeKenmerkenListHandler_5e6yc7_b4a0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
    public SNode createNodeToInsert(EditorContext editorContext) {
      SNode listOwner = super.getOwner();
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(uniekIdentificerendeKenmerkenListHandler_5e6yc7_b4a0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x218d2fe3c8aff5b9L, 0x3642b84024d34ec1L, "uniekIdentificerendeKenmerken")));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell(editorContext);
        this.installElementCellActions(super.getOwner(), null, emptyCell, editorContext);
