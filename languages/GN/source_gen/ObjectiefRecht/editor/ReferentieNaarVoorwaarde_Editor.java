...
public class ReferentieNaarVoorwaarde_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_opedlg_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_opedlg_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefCell_opedlg_a0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("voorwaarde");
    provider.setNoTargetText("<no voorwaarde>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new ReferentieNaarVoorwaarde_Editor._Inline_opedlg_a0a());
  ...
  public static class _Inline_opedlg_a0a extends InlineCellProvider {
    public _Inline_opedlg_a0a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createMultiline_opedlg_a0a0(editorContext, node);
    }
    private EditorCell createMultiline_opedlg_a0a0(EditorContext editorContext, SNode node) {
