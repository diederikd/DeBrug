...
public class TijdsverloopMetRechtsgevolg_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ri0if9_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_ri0if9_d0(editorContext, node));
  ...
  private EditorCell createRefNode_ri0if9_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new TijdsverloopMetRechtsgevolg_Editor.heeftAlsGevolgSingleRoleHandler_ri0if9_d0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d3aL, 0x202912d6e3ac6d26L, "heeftAlsGevolg"), editorContext);
    return provider.createCell();
  }
  private class heeftAlsGevolgSingleRoleHandler_ri0if9_d0 extends SingleRoleCellProvider {
    public heeftAlsGevolgSingleRoleHandler_ri0if9_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
