  ...
  public ConstraintsDescriptor getConstraints(SAbstractConcept concept) {
    {
      ...
      switch (switchIndex) {
        ...
        case 5:
          if (true) {
            return new KenmerkMetReferentieNaarKenmerk_Constraints();
          }
          break;
        case 6:
          if (true) {
            return new KenmerkMetReferentieNaarOnderwerp_Constraints();
          }
          break;
        case 7:
          if (true) {
            return new KenmerkReferentie_Constraints();
          }
          break;
        case 8:
          if (true) {
