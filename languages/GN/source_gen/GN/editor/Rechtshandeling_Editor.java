...
public class Rechtshandeling_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2759bf_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_2759bf_f0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_2759bf_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtshandeling_Editor.actorSingleRoleHandler_2759bf_d0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d3dL, 0x202912d6e3aebf6eL, "actor"), editorContext);
  ...
  private EditorCell createCollection_2759bf_f0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_2759bf_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(this.createRefNode_2759bf_a5a(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_2759bf_a5a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtshandeling_Editor.heeftAlsGevolgSingleRoleHandler_2759bf_a5a(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d3aL, 0x202912d6e3ac6d26L, "heeftAlsGevolg"), editorContext);
    return provider.createCell();
  }
  private class heeftAlsGevolgSingleRoleHandler_2759bf_a5a extends SingleRoleCellProvider {
    public heeftAlsGevolgSingleRoleHandler_2759bf_a5a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = super.createChildCell(child);
