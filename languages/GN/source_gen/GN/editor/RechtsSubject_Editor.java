...
public class RechtsSubject_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_feb60b_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_feb60b_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createProperty_feb60b_a0(EditorContext editorContext, SNode node) {
