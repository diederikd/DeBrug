...
public class Onderwerp_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_5e6yc7_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_5e6yc7_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createProperty_5e6yc7_a0(EditorContext editorContext, SNode node) {
