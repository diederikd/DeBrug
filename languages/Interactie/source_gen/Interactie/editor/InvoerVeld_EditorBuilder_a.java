...
/*package*/ class InvoerVeld_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_fs0mgt_b0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0xc4c9a68ece244c5bL, 0x9241c819e554f07cL, 0x6626bda7038194f2L, 0x6626bda7038194f3L, "referentieNaarKenmerk");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new InvoerVeld_EditorBuilder_a.Inline_Builder_fs0mgt_a1a(getEditorContext(), getNode(), targetNode).createCell();
          }
