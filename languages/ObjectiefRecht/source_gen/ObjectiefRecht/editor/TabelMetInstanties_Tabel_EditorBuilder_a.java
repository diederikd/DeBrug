...
/*package*/ class TabelMetInstanties_Tabel_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_d9mrgs_e0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x6807b3aa0b707c09L, 0x6807b3aa0b70b5b8L, "object");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new TabelMetInstanties_Tabel_EditorBuilder_a.Inline_Builder_d9mrgs_a4a(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "object");
