...
/*package*/ class ReferentieNaarWaardeVanKenmerk_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_tbidtd_a0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x3ef0712019bee4f5L, 0x3ef0712019bee4f6L, "waardevankenmerk");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ReferentieNaarWaardeVanKenmerk_EditorBuilder_a.Inline_Builder_tbidtd_a0a(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "waardevankenmerk");
      ...
      private EditorCell createRefCell_tbidtd_a0a0a0a0() {
        ...
        SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
          protected EditorCell createReferenceCell(final SNode targetNode) {
            EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
              public EditorCell compute() {
                return new ReferentieNaarWaardeVanKenmerk_EditorBuilder_a.Inline_Builder_tbidtd_a0a.Inline_Builder_tbidtd_a0a0a0.Inline_Builder_tbidtd_a0a0a0a0a(getEditorContext(), getNode(), targetNode).createCell();
              }
            }, targetNode, "kenmerk");
            CellUtil.setupIDeprecatableStyles(targetNode, cell);
            setSemanticNodeToCells(cell, getNode());
  ...
  private EditorCell createRefCell_tbidtd_c0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ReferentieNaarWaardeVanKenmerk_EditorBuilder_a.Inline_Builder_tbidtd_a2a(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "waardevankenmerk");
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
