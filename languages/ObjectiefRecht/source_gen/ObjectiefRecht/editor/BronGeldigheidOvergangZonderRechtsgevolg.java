...
public class BronGeldigheidOvergangZonderRechtsgevolg implements ConceptEditorComponent {
  @NotNull
  public Collection<String> getContextHints() {
    return Collections.emptyList();
  }
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_edy8wx_a(editorContext, node);
  }
  private EditorCell createCollection_edy8wx_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_edy8wx_a");
    editorCell.addEditorCell(this.createConstant_edy8wx_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_b0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_edy8wx_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_e0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_edy8wx_f0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_g0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_h0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_edy8wx_i0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_j0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_edy8wx_k0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_edy8wx_l0(editorContext, node));
    return editorCell;
  }
  private EditorCell createConstant_edy8wx_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_edy8wx_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_edy8wx_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_edy8wx_c0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_edy8wx_d0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_edy8wx_e0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_edy8wx_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_edy8wx_f0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
  ...
  private EditorCell createConstant_edy8wx_g0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_edy8wx_h0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_edy8wx_h0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_edy8wx_i0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidOvergangZonderRechtsgevolg.brongeldigVanSingleRoleHandler_edy8wx_i0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244baL, "brongeldigVan"), editorContext);
    return provider.createCell();
  }
  private class brongeldigVanSingleRoleHandler_edy8wx_i0 extends SingleRoleCellProvider {
  ...
  private EditorCell createConstant_edy8wx_j0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_edy8wx_k0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_edy8wx_k0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_edy8wx_l0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BronGeldigheidOvergangZonderRechtsgevolg.brongeldigTotSingleRoleHandler_edy8wx_l0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244bcL, "brongeldigTot"), editorContext);
    return provider.createCell();
  }
  private class brongeldigTotSingleRoleHandler_edy8wx_l0 extends SingleRoleCellProvider {
