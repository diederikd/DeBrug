...
/*package*/ class BronGeldigheid_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BronGeldigheid_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_7ngqyl_a();
  }

  private EditorCell createCollection_7ngqyl_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_7ngqyl_a");
    editorCell.addEditorCell(createConstant_7ngqyl_a0());
    editorCell.addEditorCell(createConstant_7ngqyl_b0());
    editorCell.addEditorCell(createProperty_7ngqyl_c0());
    editorCell.addEditorCell(createConstant_7ngqyl_d0());
    editorCell.addEditorCell(createConstant_7ngqyl_e0());
    editorCell.addEditorCell(createRefNode_7ngqyl_f0());
    editorCell.addEditorCell(createConstant_7ngqyl_g0());
    editorCell.addEditorCell(createConstant_7ngqyl_h0());
    editorCell.addEditorCell(createRefNode_7ngqyl_i0());
    return editorCell;
  }
  private EditorCell createConstant_7ngqyl_a0() {
  ...
  private EditorCell createConstant_7ngqyl_b0() {
  ...
  private EditorCell createConstant_7ngqyl_d0() {
  ...
  private EditorCell createConstant_7ngqyl_e0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_7ngqyl_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_7ngqyl_f0() {
    SingleRoleCellProvider provider = new BronGeldigheid_ComponentBuilder_a.brongeldigVanSingleRoleHandler_7ngqyl_f0(myNode, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244baL, "brongeldigVan"), getEditorContext());
    return provider.createCell();
  }
  private static class brongeldigVanSingleRoleHandler_7ngqyl_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
  ...
  private EditorCell createConstant_7ngqyl_g0() {
  ...
  private EditorCell createConstant_7ngqyl_h0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_7ngqyl_h0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_7ngqyl_i0() {
    SingleRoleCellProvider provider = new BronGeldigheid_ComponentBuilder_a.brongeldigTotSingleRoleHandler_7ngqyl_i0(myNode, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x4916e0625ce15ba0L, 0x4916e0625ce244bcL, "brongeldigTot"), getEditorContext());
    return provider.createCell();
  }
  private static class brongeldigTotSingleRoleHandler_7ngqyl_i0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
