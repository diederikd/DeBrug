...
public class Kenmerk_ZonderLidwoord_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return new Kenmerk_ZonderLidwoord_EditorBuilder_a(editorContext, node).createCell();
  }
  public EditorCell createInspectedCell(EditorContext editorContext, SNode node) {
    return new Kenmerk_ZonderLidwoord_InspectorBuilder_a(editorContext, node).createCell();
  }
}
