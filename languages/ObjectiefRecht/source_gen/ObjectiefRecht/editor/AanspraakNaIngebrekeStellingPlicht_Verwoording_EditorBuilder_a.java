      ...
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new AanspraakNaIngebrekeStellingPlicht_Verwoording_EditorBuilder_a.Inline_Builder_sj3av1_a3a(getEditorContext(), getNode(), targetNode).createCell();
          }
  ...
  private EditorCell createRefCell_sj3av1_j0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new AanspraakNaIngebrekeStellingPlicht_Verwoording_EditorBuilder_a.Inline_Builder_sj3av1_a9a(getEditorContext(), getNode(), targetNode).createCell();
          }
