...
public class ReferentieNaarOvergang_SubstituteMenu extends SubstituteMenuBase {
  ...
  public class SMP_Subconcepts_d31d83_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(MetaAdapterFactory.getConcept(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x158b926d34e0095L, "ObjectiefRecht.structure.ReferentieNaarOvergang"));
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
