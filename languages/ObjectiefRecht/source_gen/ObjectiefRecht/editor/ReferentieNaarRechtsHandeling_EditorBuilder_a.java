...
/*package*/ class ReferentieNaarRechtsHandeling_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_58p8dt_b0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x25be3715c7a014e1L, 0x25be3715c7a014e2L, "rechtshandeling");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ReferentieNaarRechtsHandeling_EditorBuilder_a.Inline_Builder_58p8dt_a1a(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "rechtshandeling");
