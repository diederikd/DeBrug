...
public class IsGroterOfGelijk_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_kynnbd_a(editorContext, node);
  }
  private EditorCell createCollection_kynnbd_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_kynnbd_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefNode_kynnbd_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_kynnbd_b0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_kynnbd_c0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_kynnbd_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new IsGroterOfGelijk_Editor.expressie1SingleRoleHandler_kynnbd_a0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b135L, "expressie1"), editorContext);
    return provider.createCell();
  }
  private class expressie1SingleRoleHandler_kynnbd_a0 extends SingleRoleCellProvider {
  ...
  private EditorCell createConstant_kynnbd_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "is groter of gelijk aan");
    editorCell.setCellId("Constant_kynnbd_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_kynnbd_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new IsGroterOfGelijk_Editor.expressie2SingleRoleHandler_kynnbd_c0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b137L, "expressie2"), editorContext);
    return provider.createCell();
  }
  private class expressie2SingleRoleHandler_kynnbd_c0 extends SingleRoleCellProvider {
