...
public class Rechtshandeling_EN_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return new Rechtshandeling_EN_EditorBuilder_a(editorContext, node).createCell();
  }
  public EditorCell createInspectedCell(EditorContext editorContext, SNode node) {
    return new Rechtshandeling_EN_InspectorBuilder_a(editorContext, node).createCell();
  }
}
