...
/*package*/ class IsGroterDan_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IsGroterDan_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_11zxmp_a();
  }

  private EditorCell createCollection_11zxmp_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_11zxmp_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createRefNode_11zxmp_a0());
    editorCell.addEditorCell(createConstant_11zxmp_b0());
    editorCell.addEditorCell(createRefNode_11zxmp_c0());
    return editorCell;
  }
  private EditorCell createRefNode_11zxmp_a0() {
    SingleRoleCellProvider provider = new IsGroterDan_EditorBuilder_a.expressie1SingleRoleHandler_11zxmp_a0(myNode, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b135L, "expressie1"), getEditorContext());
    return provider.createCell();
  }
  private static class expressie1SingleRoleHandler_11zxmp_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
  ...
  private EditorCell createConstant_11zxmp_b0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "is groter dan");
    editorCell.setCellId("Constant_11zxmp_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_11zxmp_c0() {
    SingleRoleCellProvider provider = new IsGroterDan_EditorBuilder_a.expressie2SingleRoleHandler_11zxmp_c0(myNode, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b137L, "expressie2"), getEditorContext());
    return provider.createCell();
  }
  private static class expressie2SingleRoleHandler_11zxmp_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
