...
public class Kenmerk_MetLidwoord_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return new Kenmerk_MetLidwoord_EditorBuilder_a(editorContext, node).createCell();
  }
  public EditorCell createInspectedCell(EditorContext editorContext, SNode node) {
    return new Kenmerk_MetLidwoord_InspectorBuilder_a(editorContext, node).createCell();
  }
}
