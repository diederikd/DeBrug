          ...
          protected EditorCell createReferenceCell(final SNode targetNode) {
            EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
              public EditorCell compute() {
                return new IsGeen_EditorBuilder_a.Inline_Builder_drg1ot_a0a.Inline_Builder_drg1ot_a0a0a0.Inline_Builder_drg1ot_a0a0a0a0a(getEditorContext(), getNode(), targetNode).createCell();
              }
            }, targetNode, "object");
      ...
      private EditorCell createRefCell_drg1ot_a0a0a0c0() {
        ...
        SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
          protected EditorCell createReferenceCell(final SNode targetNode) {
            EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
              public EditorCell compute() {
                return new IsGeen_EditorBuilder_a.Inline_Builder_drg1ot_a2a.Inline_Builder_drg1ot_a0a0c0.Inline_Builder_drg1ot_a0a0a0a2a(getEditorContext(), getNode(), targetNode).createCell();
              }
            }, targetNode, "kenmerk");
            CellUtil.setupIDeprecatableStyles(targetNode, cell);
            setSemanticNodeToCells(cell, getNode());
