...
public class IsKleinerDan_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_gylfkj_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new IsKleinerDan_Editor.expressie1SingleRoleHandler_gylfkj_a0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b135L, "expressie1"), editorContext);
    return provider.createCell();
  }
  private class expressie1SingleRoleHandler_gylfkj_a0 extends SingleRoleCellProvider {
    public expressie1SingleRoleHandler_gylfkj_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_gylfkj_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new IsKleinerDan_Editor.expressie2SingleRoleHandler_gylfkj_c0(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x46db58718361b134L, 0x46db58718361b137L, "expressie2"), editorContext);
    return provider.createCell();
  }
  private class expressie2SingleRoleHandler_gylfkj_c0 extends SingleRoleCellProvider {
    public expressie2SingleRoleHandler_gylfkj_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
