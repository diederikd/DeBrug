...
/*package*/ class OnderwerpType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_n6hw22_a0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x3c0e42171c23d5b5L, 0x3c0e42171c23d5b6L, "onderwerp");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new OnderwerpType_EditorBuilder_a.Inline_Builder_n6hw22_a0a(getEditorContext(), getNode(), targetNode).createCell();
          }
