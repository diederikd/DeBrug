...
public class VerwoordingWaarde_TransformationMenu extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new VerwoordingWaarde_TransformationMenu.TransformationMenuPart_Action_ga4xcn_a0());
    }
    return result;
  }

  private class TransformationMenuPart_Action_ga4xcn_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      return new VerwoordingWaarde_TransformationMenu.TransformationMenuPart_Action_ga4xcn_a0.Item(context);
    }
