...
/*package*/ class VoorbeeldenMetInstanties_Tabel_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public VoorbeeldenMetInstanties_Tabel_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_a64qvm_a();
  }

  private EditorCell createCollection_a64qvm_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_a64qvm_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createTable_a64qvm_a0_0());
    editorCell.addEditorCell(createConstant_a64qvm_b0());
    editorCell.addEditorCell(createConstant_a64qvm_c0());
    editorCell.addEditorCell(createConstant_a64qvm_d0());
    editorCell.addEditorCell(createRefNode_a64qvm_e0());
    return editorCell;
  }
  ...
  private EditorCell createTable_a64qvm_a0_0() {
    return createTable_a64qvm_a0(getEditorContext(), myNode);
  }
  ...
  private EditorCell createConstant_a64qvm_b0() {
  ...
  private EditorCell createConstant_a64qvm_c0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
  ...
  private EditorCell createConstant_a64qvm_d0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
  ...
  private EditorCell createRefNode_a64qvm_e0() {
    SingleRoleCellProvider provider = new VoorbeeldenMetInstanties_Tabel_EditorBuilder_a.verwoordingenSingleRoleHandler_a64qvm_e0(myNode, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x36e4484084e2ca1aL, 0x48a9ceab914f75c3L, "verwoordingen"), getEditorContext());
    return provider.createCell();
  }
  private static class verwoordingenSingleRoleHandler_a64qvm_e0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x36e4484084e2ca1aL, 0x48a9ceab914f75c3L, "verwoordingen"), child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x36e4484084e2ca1aL, 0x48a9ceab914f75c3L, "verwoordingen"), child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell, myNode, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x36e4484084e2ca1aL, 0x48a9ceab914f75c3L, "verwoordingen"), child));
      }
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x36e4484084e2ca1aL, 0x48a9ceab914f75c3L, "verwoordingen")));
      try {
