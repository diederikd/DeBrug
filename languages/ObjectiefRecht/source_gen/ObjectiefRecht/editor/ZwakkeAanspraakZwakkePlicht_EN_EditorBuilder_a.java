      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ZwakkeAanspraakZwakkePlicht_EN_EditorBuilder_a.Inline_Builder_vcx8b9_a11a(getEditorContext(), myNode, effectiveNode).createCell();
          }
  ...
  private EditorCell createRefCell_vcx8b9_o0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ZwakkeAanspraakZwakkePlicht_EN_EditorBuilder_a.Inline_Builder_vcx8b9_a41a(getEditorContext(), myNode, effectiveNode).createCell();
          }
