...
public class InterpreterTemporal_extension extends Extension.Default<IInterpreter> {
  public InterpreterTemporal_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterInterpreterTemporal();
  }
}
