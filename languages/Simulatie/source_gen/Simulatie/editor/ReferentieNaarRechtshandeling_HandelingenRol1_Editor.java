...
public class ReferentieNaarRechtshandeling_HandelingenRol1_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ljvns5_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createReadOnlyModelAccessor_ljvns5_h0a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_ljvns5_i0a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createReadOnlyModelAccessor_ljvns5_h0a(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_ljvns5_h0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_ljvns5_i0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_ljvns5_i0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
