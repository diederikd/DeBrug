...
/*package*/ class Rechtsbetrekking_Simulatie_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Rechtsbetrekking_Simulatie_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_o8qqqk_a_0();
  }
  ...
  private EditorCell createConstant_o8qqqk_a0_0() {
  ...
  private EditorCell createConstant_o8qqqk_b0() {
  ...
  private EditorCell createRefNode_o8qqqk_c0() {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Simulatie_InspectorBuilder_a.geldigVanSingleRoleHandler_o8qqqk_c0(myNode, MetaAdapterFactory.getContainmentLink(0x2c493149da1d45e9L, 0x8ea2e0b0cfc3047aL, 0x630944a3c415c89eL, 0x630944a3c415c8cdL, "geldigVan"), getEditorContext());
    return provider.createCell();
  }
  private static class geldigVanSingleRoleHandler_o8qqqk_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
  ...
  private EditorCell createConstant_o8qqqk_d0() {
  ...
  private EditorCell createConstant_o8qqqk_e0_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
  ...
  private EditorCell createRefNode_o8qqqk_f0() {
    SingleRoleCellProvider provider = new Rechtsbetrekking_Simulatie_InspectorBuilder_a.geldigTotSingleRoleHandler_o8qqqk_f0(myNode, MetaAdapterFactory.getContainmentLink(0x2c493149da1d45e9L, 0x8ea2e0b0cfc3047aL, 0x630944a3c415c89eL, 0x630944a3c415c8d4L, "geldigTot"), getEditorContext());
    return provider.createCell();
  }
  private static class geldigTotSingleRoleHandler_o8qqqk_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
