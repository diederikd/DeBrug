...
public class Rechtshandeling_HandelingenRol2_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9we733_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_9we733_a0a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_9we733_b0a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_9we733_c0a(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_9we733_d0a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_9we733_e0a(editorContext, node));
    editorCell.addEditorCell(this.createJComponent_9we733_f0a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_9we733_g0a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_9we733_a0a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_9we733_b0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, " door rechtssubject");
    editorCell.setCellId("Constant_9we733_b0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_9we733_d0a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Rechtshandeling_HandelingenRol2_Editor.rechtssubjectSingleRoleHandler_9we733_d0a(node, MetaAdapterFactory.getContainmentLink(0x8dc4b25f4c49400eL, 0xac370fd230db702cL, 0x611073d615228d3dL, 0x202912d6e3aebf6eL, "rechtssubject"), editorContext);
    return provider.createCell();
  }
  private class rechtssubjectSingleRoleHandler_9we733_d0a extends SingleRoleCellProvider {
    public rechtssubjectSingleRoleHandler_9we733_d0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_9we733_e0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, " ");
    editorCell.setCellId("Constant_9we733_e0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createJComponent_9we733_f0a(EditorContext editorContext, SNode node) {
    EditorCell editorCell = EditorCell_Component.createComponentCell(editorContext, node, Rechtshandeling_HandelingenRol2_Editor._QueryFunction_JComponent_9we733_a5a0(node, editorContext), "_9we733_f0a");
    editorCell.setCellId("JComponent_9we733_f0a");
    return editorCell;
  }
  private static JComponent _QueryFunction_JComponent_9we733_a5a0(final SNode node, final EditorContext editorContext) {
  ...
  private EditorCell createConstant_9we733_g0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_9we733_g0a");
    Style style = new StyleImpl();
