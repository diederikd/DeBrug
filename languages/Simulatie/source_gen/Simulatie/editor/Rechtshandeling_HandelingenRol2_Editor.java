...
public class Rechtshandeling_HandelingenRol2_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9we733_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_9we733_h0a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_9we733_h0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_9we733_h0a");
    Style style = new StyleImpl();
