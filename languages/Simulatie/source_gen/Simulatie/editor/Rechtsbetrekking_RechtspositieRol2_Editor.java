...
public class Rechtsbetrekking_RechtspositieRol2_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return new Rechtsbetrekking_RechtspositieRol2_EditorBuilder_a(editorContext, node).createCell();
  }
  public EditorCell createInspectedCell(EditorContext editorContext, SNode node) {
    return new Rechtsbetrekking_RechtspositieRol2_InspectorBuilder_a(editorContext, node).createCell();
  }
}
