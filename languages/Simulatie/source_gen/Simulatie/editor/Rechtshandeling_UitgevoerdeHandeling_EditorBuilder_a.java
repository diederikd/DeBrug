  ...
  private EditorCell createRefCell_qsh53x_f0a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new Rechtshandeling_UitgevoerdeHandeling_EditorBuilder_a.Inline_Builder_qsh53x_a5a0(getEditorContext(), myNode, effectiveNode).createCell();
          }
  ...
  private EditorCell createRefCell_qsh53x_i0a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new Rechtshandeling_UitgevoerdeHandeling_EditorBuilder_a.Inline_Builder_qsh53x_a8a0(getEditorContext(), myNode, effectiveNode).createCell();
          }
    ...
    private EditorCell createRefCell_qsh53x_a0a8a0() {
      CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
        ...
        protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
          EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
            public EditorCell compute() {
              return new Rechtshandeling_UitgevoerdeHandeling_EditorBuilder_a.Inline_Builder_qsh53x_a8a0.Inline_Builder_qsh53x_a0a0i0a(getEditorContext(), myNode, effectiveNode).createCell();
            }
