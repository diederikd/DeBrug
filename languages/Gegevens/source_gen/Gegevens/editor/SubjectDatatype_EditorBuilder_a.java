...
/*package*/ class SubjectDatatype_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_hmtrym_a0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x30ef095ad48945ffL, 0xa80f456a798ac125L, 0x1fabc0b15d70a669L, 0x1fabc0b15d70a66aL, "subject");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new SubjectDatatype_EditorBuilder_a.Inline_Builder_hmtrym_a0a(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "subject");
    ...
    private EditorCell createRefCell_hmtrym_a0a0a() {
      ...
      SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
        protected EditorCell createReferenceCell(final SNode targetNode) {
          EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
            public EditorCell compute() {
              return new SubjectDatatype_EditorBuilder_a.Inline_Builder_hmtrym_a0a.Inline_Builder_hmtrym_a0a0a0(getEditorContext(), getNode(), targetNode).createCell();
            }
          }, targetNode, "subject");
          CellUtil.setupIDeprecatableStyles(targetNode, cell);
          setSemanticNodeToCells(cell, getNode());
