...
public class ReferentieNaarKenmerk_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_mq86k9_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_mq86k9_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_mq86k9_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new ReferentieNaarKenmerk_Editor.datatypeSingleRoleHandler_mq86k9_c0(node, MetaAdapterFactory.getContainmentLink(0x30ef095ad48945ffL, 0xa80f456a798ac125L, 0x76ccb41bf37d6dbaL, 0x688d4c283dbb8ba4L, "datatype"), editorContext);
    return provider.createCell();
  }
  private class datatypeSingleRoleHandler_mq86k9_c0 extends SingleRoleCellProvider {
    public datatypeSingleRoleHandler_mq86k9_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
