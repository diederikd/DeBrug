...
/*package*/ class Uren_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_gjow6b_a0() {
    ...
    try {
      final SProperty property = MetaAdapterFactory.getProperty(0x61be2dc6a1404defL, 0xa5927499aa2bac19L, 0x46db587183b2cba1L, 0x46db587183b2cba2L, "uren");
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no uren>");
