...
<model ref="00000000-0000-4000-5f02-5beb5f025beb/i:fd8ff61(checkpoints/Datum.textGen@descriptorclasses)">
  <persistence version="9" />
  <attribute name="checkpoint" value="DescriptorClasses" />
  <attribute name="generation-plan" value="AspectCPS" />
  <languages />
  <imports>
    <import index="migm" ref="r:8805ccc8-af57-4736-9a5d-23874a4f068f(Datum.textGen)" />
  ...
  <node concept="312cEu" id="0">
    ...
    <property role="TrG5h" value="DatumTijd_TextGen" />
  ...
  <node concept="39dXUE" id="p">
    <node concept="39e2AJ" id="q" role="39e2AI">
      ...
      <node concept="39e2AG" id="s" role="39e3Y0">
        <ref role="39e2AK" to="migm:5vursKRvQoP" resolve="DatumTijd_TextGen" />
        <node concept="385nmt" id="t" role="385vvn">
          <property role="385vuF" value="DatumTijd_TextGen" />
        ...
        <node concept="39e2AT" id="u" role="39e2AY">
          <ref role="39e2AS" node="0" resolve="DatumTijd_TextGen" />
        </node>
      </node>
    </node>
  ...
  <node concept="312cEu" id="$">
    ...
    <node concept="312cEg" id="_" role="jymVt">
      ...
      <node concept="2eloPW" id="I" role="1tU5fm">
        <property role="2ely0U" value="Datum.structure.LanguageConceptSwitch" />
        <ref role="3uigEE" to="tpcf:1OW7rNmnulT" resolve="LanguageConceptSwitch" />
      </node>
      <node concept="2ShNRf" id="J" role="33vP2m">
        <node concept="xCZzO" id="K" role="2ShVmc">
          <property role="xCZzQ" value="Datum.structure.LanguageConceptSwitch" />
        ...
        <node concept="3KaCP$" id="X" role="3cqZAp">
          ...
          <node concept="3KbdKl" id="10" role="3KbHQx">
            <node concept="1n$iZg" id="14" role="3Kbmr1">
              <property role="1n_iUB" value="DatumTijd" />
              <property role="1n_ezw" value="Datum.structure.LanguageConceptSwitch" />
            </node>
            <node concept="3clFbS" id="15" role="3Kbo56">
              <node concept="3cpWs6" id="16" role="3cqZAp">
                <node concept="2ShNRf" id="17" role="3cqZAk">
                  <node concept="HV5vD" id="18" role="2ShVmc">
                    <ref role="HV5vE" node="0" resolve="DatumTijd_TextGen" />
                  </node>
                </node>
              </node>
            </node>
