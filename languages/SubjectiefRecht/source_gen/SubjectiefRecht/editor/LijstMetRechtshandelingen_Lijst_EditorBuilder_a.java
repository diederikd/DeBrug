...
/*package*/ class LijstMetRechtshandelingen_Lijst_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LijstMetRechtshandelingen_Lijst_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createTable_vyxdba_a_0();
  }

  private EditorCell createTable_vyxdba_a(final EditorContext editorContext, final SNode node) {
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_vyxdba_a0(editorContext, node);
              ...
              editorCell.value.setCellId("Table_vyxdba_a");
  ...
  private EditorCell createTable_vyxdba_a_0() {
    return createTable_vyxdba_a(getEditorContext(), myNode);
  }
  public Grid createChildsVertical_vyxdba_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createStaticHeader_vyxdba_a0a(editorContext, node));
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x2c493149da1d45e9L, 0x8ea2e0b0cfc3047aL, 0x2b935eb9660efb14L, 0x2b935eb9660efb15L, "rechtshandelingen"))).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, MetaAdapterFactory.getContainmentLink(0x2c493149da1d45e9L, 0x8ea2e0b0cfc3047aL, 0x2b935eb9660efb14L, 0x2b935eb9660efb15L, "rechtshandelingen"), editorContext);
  ...
  public HeaderGrid createStaticHeader_vyxdba_a0a(final EditorContext editorContext, final SNode snode) {
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Rechtshandelingen", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Rechtshandelingen"), cell);
    header.setLabel("Rechtshandelingen");
